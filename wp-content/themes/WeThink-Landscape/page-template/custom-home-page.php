          ...
          <div class="col-lg-3 col-md-6">
            <div class="serv-box">
              ...
              <div class="expertise-btn">
                <a href="<?php echo esc_url(get_site_url()); ?>/services"><?php esc_html_e( 'READ MORE', 'vw-gardening-landscaping' ); ?><span class="screen-reader-text"><?php esc_html_e( 'READ MORE','vw-gardening-landscaping' );?></span></a>
              </div>
            </div>
          </div>
          <?php endwhile;
